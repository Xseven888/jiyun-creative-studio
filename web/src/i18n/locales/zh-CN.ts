export default {
    ...
    config: {
        ...
        channels: {
            description: "默认使用 DreaYun 的固定 OpenAI 兼容接口。输入 API Key 后即可选择模型、指定能力并配置调用脚本。",
            add: "新增渠道",
            unnamed: "未命名渠道",
        ...
        channelEditor: {
            ...
            openDreayunTokenPage: "前往复制秘钥",
            importApiKeyFromClipboard: "从剪贴板导入 API Key",
            clipboardApiKeyImported: "API Key 已导入",
            clipboardApiKeyEmpty: "剪贴板中没有找到 API Key",
            clipboardApiKeyReadFailed: "无法读取剪贴板，请允许剪贴板权限后重试",
            capabilities: {
                image: "生图",
                video: "视频",
                text: "文本",
    ...
    agent: {
        mode: { browser: "内置 Agent", local: "本地 Codex" },
        ...
        browser: { title: "内置 Agent", canvasRequired: "请先打开一个画布", configRequired: "内置 Agent 需要可用的文本模型配置", openConfig: "配置文本模型", empty: "告诉我你想怎样整理或修改当前画布", running: "正在读取并操作画布…", placeholder: "让 Agent 操作当前画布", stop: "停止", stopped: "已停止本次请求", toolTitle: "画布操作", toolApplied: "已执行 {{count}} 项画布操作", requestFailed: "内置 Agent 请求失败" },
