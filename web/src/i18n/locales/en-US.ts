export default {
    ...
    config: {
        ...
        channels: {
            description: "The default DreaYun channel uses the fixed OpenAI-compatible endpoint. Enter an API key, then choose models and capabilities below.",
            add: "Add provider",
        ...
        channelEditor: {
            ...
            openDreayunTokenPage: "Open DreaYun token page",
            importApiKeyFromClipboard: "Import API key from clipboard",
            clipboardApiKeyImported: "API key imported",
            clipboardApiKeyEmpty: "No API key was found in the clipboard",
            clipboardApiKeyReadFailed: "Could not read the clipboard. Allow clipboard access and try again.",
            capabilities: {
                image: "Image",
                video: "Video",
                text: "Text",
        ...
        modelSelect: {
            missingConfig: "Enter an API key first",
    ...
    agent: {
        mode: { browser: "Built-in Agent", local: "Local Codex" },
        ...
        browser: { title: "Built-in Agent", canvasRequired: "Open a canvas first", configRequired: "The built-in Agent needs a configured text model", openConfig: "Configure text model", empty: "Tell me how you want to organize or change this canvas", running: "Reading and updating the canvas…", placeholder: "Ask the Agent to update this canvas", stop: "Stop", stopped: "This request was stopped", toolTitle: "Canvas operation", toolApplied: "Applied {{count}} canvas operations", requestFailed: "Built-in Agent request failed" },
