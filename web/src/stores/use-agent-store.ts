...
export type AgentMode = "browser" | "local";
...
type AgentStore = {
    ...
    setAgentState: (patch: Partial<Omit<AgentStore, "setAgentState" | "setMode" | "connectAgent" | "disconnectAgent" | "addMessage" | "addEventLog" | "clearEventLogs" | "openPanel" | "closePanel" | "togglePanel" | "setCanvasContext">>) => void;
    ...
    disconnectAgent: (patch?: Partial<Omit<AgentStore, "setAgentState" | "setMode" | "connectAgent" | "disconnectAgent" | "addMessage" | "addEventLog" | "clearEventLogs" | "openPanel" | "closePanel" | "togglePanel" | "setCanvasContext">>) => void;
...
export const useAgentStore = create<AgentStore>((set, get) => ({
    mode: typeof window === "undefined" ? "browser" : (localStorage.getItem("canvas-agent-mode") as AgentMode) === "local" ? "local" : "browser",
