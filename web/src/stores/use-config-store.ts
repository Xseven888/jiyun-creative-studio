...
const DEFAULT_CHANNEL_BASE_URL = "https://api.dreayun.com";
...
export const defaultConfig: AiConfig = {
    ...
    channels: [
        {
            ...
            models: [
                ...
                { name: "veo_3_1-components", capability: "video" },
    ...
    videoModel: "default::veo_3_1-components",
    ...
    models: ["default::gpt-image-2", "default::veo_3_1-components", "default::gpt-5.6-sol", "default::gpt-4o-mini-tts"],
    quality: "auto",
    size: "1:1",
    background: "",
    count: "1",
...
export function defaultBaseUrlForApiFormat(apiFormat: ApiCallFormat) {
    ...
    return DEFAULT_CHANNEL_BASE_URL;
}
